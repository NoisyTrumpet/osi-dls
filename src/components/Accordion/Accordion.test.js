    ...
    const Acc = (
      <Accordion>
        ...
        <Accordion.Section title="Section 2" titleID="accordion2id" panelId="sect2">
          <img src="https://webfileswest.uswest.os.ctl.io/corporate.hallmark.com/wp-content/uploads/2018/06/Hallmark-Greetings-Logo-black-160x160.jpg" alt="Hallmark" />
        </Accordion.Section>
        <Accordion.Section title="Section Link" titleID="accordion4id" panelId="sect4" link="https://www.hallmark.com/" />
      </Accordion>
    );
