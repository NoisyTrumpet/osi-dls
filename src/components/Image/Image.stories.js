...
const parameters = {
  component: Image,
  componentSubtitle:
    "The <Image/> tag defines a <img> tag with optional sources. This component does not render children.",
  jest: ["Image"]
};
  ...
  .add("Mulitple Sources (Responsive)", () => (
    ...
    >
      <Image.Source
        ...
        srcSet="https://www.w3schools.com/tags/img_orange_flowers.jpg"
      />
      <Image.Source
