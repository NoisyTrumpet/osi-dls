...
const URLToTest = 'https://www.hallmark.com/';
...
describe('<Textlink />', () => {
  ...
  test('Should find and click of the component <TextLink />, based on text-query, resulting in page load of https://www.hallmark.com/', () => {
